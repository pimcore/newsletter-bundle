...
pimcore.registerNS("pimcore.bundle.newsletter.document.newsletters.addressSourceAdapters.default");
/**
 * @private
 */
pimcore.bundle.newsletter.document.newsletters.addressSourceAdapters.default = Class.create({
                ...
                items: [
                    {
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                type: 'ajax',
                                url: Routing.generate('pimcore_bundle_newsletter_document_newsletter_getavailableclasses'),
                                reader: {
                                    type: 'json',
                                    rootProperty: 'data'
                                }
                        ...
                        listeners: {
                            keyup: function (el) {
                                ...
                                Ext.Ajax.request({
                                    url: Routing.generate('pimcore_bundle_newsletter_document_newsletter_checksql'),
                                    method: "POST",
