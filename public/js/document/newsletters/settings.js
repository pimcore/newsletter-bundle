...
pimcore.registerNS("pimcore.bundle.newsletter.document.newsletters.settings");
/**
 * @private
 */
pimcore.bundle.newsletter.document.newsletters.settings = Class.create(pimcore.document.settings_abstract, {
