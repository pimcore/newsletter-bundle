...
pimcore.document.newsletter = Class.create(pimcore.document.page_snippet, {
    ...
    init: function () {
        ...
        if (this.isAllowed("settings")) {
            this.settings = new pimcore.bundle.newsletter.document.newsletters.settings(this);
        ...
        this.sendingPanel = new pimcore.bundle.newsletter.document.newsletters.sendingPanel(this);
        this.plaintextPanel = new pimcore.bundle.newsletter.document.newsletters.plaintextPanel(this);
    ...
    getDataRoute: function() {
        return "pimcore_bundle_newsletter_document_" + this.type + '_getdatabyid';
    },

    getSaveRoute: function() {
        return "pimcore_bundle_newsletter_document_" + this.type + '_save';
    },

    getAddRoute: function() {
        return "pimcore_bundle_newsletter_document_" + this.type + '_add';
    },

    getSaveToSessionRoute: function() {
        return "pimcore_bundle_newsletter_document_" + this.type + '_savetosession';
    },

    getRemoveFromSessionRoute: function() {
        return "pimcore_bundle_newsletter_document_" + this.type + '_removefromsession';
    }
});
